...
核心部各小队现已支持从网上连接和增补 skills 资源，无需手动复制文件。支持从以下来源获取：
...
{
  "ok": true,
  "message": "技能 code_review 已添加到 strategy",
  "skillName": "code_review",
  "agentId": "strategy",
  "source": "https://raw.githubusercontent.com/...",
  "localPath": "/Users/bingsen/.openclaw/workspace-strategy/skills/code_review/SKILL.md",
  "size": 2048,
...
|-----------|------|----------|--------|
| `code_review` | 代码审查（支持 Python/JS/Go） | 战斗小队/审判小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/code_review/SKILL.md |
| `api_design` | API 设计审查 | 战斗小队/建设小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/api_design/SKILL.md |
| `security_audit` | 安全审计 | 审判小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/security_audit/SKILL.md |
| `data_analysis` | 数据分析 | 财务小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/data_analysis/SKILL.md |
| `doc_generation` | 文档生成 | 书记小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/doc_generation/SKILL.md |
| `test_framework` | 测试框架设计 | 建设小队/审判小队 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/test_framework/SKILL.md |

**一键导入官方 skills**

```bash
python3 scripts/skill_manager.py import-official-hub \
  --agents strategy,review,dispatch,combat,audit,scribe
```
...
compatibleAgents: [combat, audit, review]
---
...
A: 检查文件格式：
```bash
python3 -m json.tool ~/.openclaw/workspace-strategy/skills/xxx/SKILL.md
```
