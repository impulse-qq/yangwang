...
核心部各小队不是 metaphor，是真的分权制衡。公众号里你能看到：

- **为什么监察部是杀手锏** —— 以及它驳回了多少次策划部的方案
- **副团长凭什么当分拣员** —— Intent Detection 的古今之辩
- **各小队并行为啥不打架** —— 从唐代到 goroutine 的并发智慧
...
- 🔥 *Token 烧了 $50，结果监察部把方案驳回了三次*
- 🐛 *调度部派发任务，各小队全体罢工——原来 agent ID 写错了*
...
| 日期 | 标题 | 亮点 |
|------|------|------|
| 2026.03 | 核心部各小队 · 250 Star 里程碑复盘 | 5 个 Issue + 20 条评论逐一回应，Token 优化方案 |
