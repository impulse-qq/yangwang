...
def parse_old_task(old: dict) -> dict:
    ...
    state_str = old.get("state", "Vice")
    state = STATE_MAP.get(state_str, TaskState.Vice)
    ...
    return {
        ...
        "creator": old.get("official", "master"),
